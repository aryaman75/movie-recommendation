...
st.markdown("<h1 style='text-align: center; color: black;'>Movie Recommendation System</h1>", unsafe_allow_html=True)
...
st.markdown("<h4 style='text-align: center; color: black;'>Web App created by Aryaman Pandita</h4>", unsafe_allow_html=True)
